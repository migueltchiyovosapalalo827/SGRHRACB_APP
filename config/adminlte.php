...
return [
    ...
    */
    ...
    'title' => 'REGIMENTO AÉREO DE CAÇA-BOMBARDEIROS SISGRH',
    'title_prefix' => '',
    'title_postfix' => '',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Lista de sub-unidades',
                    'url'  => 'unidades',
                    'icon' => 'fas fa-fw fa-home',
                ],
                [
                    'text' => 'cadastrar sub-unidades',
                    'url'  => 'unidades/create',
        ...
        [
            'text'    => 'Subcategoria Militar',
            'icon'    => 'far fa-list-alt',
            'submenu' => [
                [
                    'text' => 'Lista de sub-categoria',
                    'url'  => 'subcategoria',
                    'icon' => 'fas fa-fw fa-list',
                ],
                [
                    'text' => 'cadastrar sub-categoria',
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Lista de permissões',
                    'url'  => 'permissao',
                    'icon' => 'fas fa-fw fa-list',
                ],
                [
                    'text' => 'cadastrar permissão',
                    'url'  => 'permissao/create',
                    'icon' => 'fas fa-fw fa-plus',
                ],
            ],
        ],
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Lista de efectivos',
                    'url'  => 'efectivos',
                    'icon' => 'fas fa-fw fa-list',
                ],
                [
                    'text' => 'cadastrar efectivos',
                    'url'  => 'efectivos/create',
                    'icon' => 'fas fa-fw fa-plus',
                ],
            ],
        ],
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Lista de hablitações',
                    'url'  => 'hablitacao',
                    'icon' => 'fas  fa-fw fa-list',
                ],

                [
                    'text' => 'cadastrar hablitações',
                    'url'  => 'hablitacao/create',
                    'icon' => 'fas  fa-fw fa-plus',
                ],
            ]
        ],
