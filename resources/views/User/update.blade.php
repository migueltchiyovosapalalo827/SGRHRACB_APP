                ...
                <div class="card card-default">
                    <div class="card-header">
                        <div class="float-left">
                            <div class="btn-group">
                                <a href="{{ route('user.index') }}" class="btn btn-sm btn-block btn-secondary"><i
                    ...
                    <div class="card-body p-0">
                        <div class="bs-stepper">
                            <div class="bs-stepper-header" role="tablist">
                                ...
                                <div class="line"></div>
                                <div class="step" data-target="#acesso-part">
                                    <button type="button" class="step-trigger" role="tab" aria-controls="acesso-part"
                                        id="acesso-part-trigger">
                                        <span class="bs-stepper-circle">3</span>
                                        <span class="bs-stepper-label">Informação de acesso ao sistema</span>
                                    </button>
                                </div>
                            ...
                            <div class="bs-stepper-content">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="nome" placeholder="Nome" value="{{ $user->name ?? old('nome') }}">
                                                @error('nome')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="nip" placeholder="NIP" value="{{$user->efectivo->nip ?? old('nip') }}">
                                                @error('nip')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{$user->efectivo->numero_do_bi ?? old('numero_do_bi') }}">
                                                @error('numero_do_bi')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date"
                                                    ...
                                                    placeholder="Data de Emissão" value="{{$user->efectivo->data_de_emissao ?? old('data_de_emissao') }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date"
                                                    ...
                                                    value="{{$user->efectivo->data_de_nascimento ?? old('data_de_nascimento') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control @error('genero') is-invalid @enderror"
                                                    ...
                                                    <option value="Masculino"
                                                        {{ $user->efectivo->genero ?? old('genero') == 'Masculino' ? 'selected' : '' }}>Masculino
                                                    </option>
                                                    <option value="Feminino"
                                                        {{ $user->efectivo->genero ?? old('genero') == 'Feminino' ? 'Feminino' : '' }}>Feminino
                                                    </option>
                                                </select>
                                                @error('genero')
                                                    <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{$user->efectivo->iban ?? old('iban') }}">
                                                @error('iban')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{$user->efectivo->fliacao ?? old('fliacao') }}">
                                                @error('fliacao')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                                ...
                                                <select name="forma_de_prestacao_de_servico" id="fps"
                                                    ...
                                                    @foreach ($fps as $fp)
                                                        <option value="{{ $fp->value }}"
                                                            {{$user->efectivo->fps ?? old('forma_de_prestacao_de_servico') == $fp->value ? 'selected' : '' }}>
                                                            {{ $fp->value }}</option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <select class="form-control @error('quadro_especial') is-invalid @enderror"
                                                    ...
                                                    @foreach ($quadros as $quadro)
                                                        <option value="{{ $quadro->id }}"
                                                            {{ old('quadro_especial') ?? $user->efectivo->quadro_especial->id == $quadro->id ? 'selected' : '' }}>
                                                            {{ $quadro->nome }}</option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <select class="form-control @error('unidade') is-invalid @enderror"
                                                    ...
                                                    @foreach ($unidades as $unidade)
                                                        <option value="{{ $unidade->id }}"
                                                            {{ $user->efectivo->unidade->id ??old('unidade') == $unidade->id ? 'selected' : '' }}>
                                                            {{ $unidade->nome }}</option>
                                                    @endforeach
                                                </select>
                                                @error('unidade')
                                                ...
                                                <select class="form-control @error('categoria') is-invalid @enderror"
                                                    ...
                                                    @foreach ($categorias as $categoria)
                                                        <option value="{{ $categoria->id }}"
                                                            {{old('categoria') ?? $user->efectivo->subcategoria->categoria->id  == $categoria->id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date"
                                                    ...
                                                    value="{{$user->efectivo->data_de_incorporacao ?? old('data_de_incorporacao') }}">
                                ...
                                <div id="acesso-part" class="content" role="tabpanel"
                                    aria-labelledby="acesso-part-trigger">
                                    <!--  cargos	email password -->
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label>Cargos ou funções exercidas</label>
                                                <select class="duallistbox @error('cargos') is-invalid @enderror"
                                                    multiple="multiple", name="cargos[]">

                                                    @foreach ($cargos as $cargo)
                                                        <option value="{{ $cargo->id }}"
                                                            {{in_array($cargo->id,$user->cargos->pluck('id')->toArray()) ? 'selected' : '' }}>
                                                            {{ $cargo->nome }}</option>
                                                    @endforeach
                                                </select>
                                                @error('cargo')
...
@section('js')
    <script>
        $(function() {
            ...
            if (`{{$user->efectivo->subcategoria->categoria->id}}` != '') {
                var categoria_id = $('#categoria').val();
                var _token = $('input[name="_token"]').val();
                var option = '<option value="">Selecione</option>';
                $.ajax({
                    url: `{{ url('categoriasGetsubcategorias/'.$user->efectivo->subcategoria->categoria->id) }}`,
                    method: "POST",
                    data: {
                        _token: _token
                    },
                    success: function(data) {
                        console.log(data);
                        $.each(data, function(key, value) {
                            if (value.id == `{{$user->efectivo->subcategoria->id}}`) {
                                option += '<option value="' + value.id + '" selected >' + value.nome +
                                '</option>';
                            } else {
                                option += '<option value="' + value.id + '">' + value.nome +
                                '</option>';
